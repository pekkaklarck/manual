...
The [reStructuredText format](data.md#restructuredtext-format) that can be used with [suite files](suites.md#suite-files)  works
...
The [Markdown format](data.md#markdown-format) that can be used with [suite files](suites.md#suite-files) works also with
