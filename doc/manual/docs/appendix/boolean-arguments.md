...
Many keywords in Robot Framework [standard libraries](../creating-test-data/using-test-libraries.md#standard-libraries) accept arguments that
...
[rules as in Python](http://docs.python.org/library/stdtypes.html#truth-value-testing).
