...
Robot Framework supports translating [section headers](../syntax/data.md#test-data-sections), [settings](settings.md#available-settings),
...
| Test Tags | Testin Tunnisteet |
| Task Tags | Tehtävän Tunnisteet |
| Keyword Tags | Avainsanan Tunnisteet |
| Tags | Tunnisteet |
| Setup | Alustus |
| Teardown | Alasajo |
| Template | Malli |
...
| Old term | New term | Deprecated |
|---|---|---|
| Tagit | Tunnisteet | RF 7.5 |
| Avainsanan Tagit | Avainsanan Tunnisteet | RF 7.5 |
| Testin Tagit | Testin Tunnisteet | RF 7.5 |
| Tehtävän Tagit | Tehtävän Tunnisteet | RF 7.5 |
...
| Old term | New term | Deprecated |
|---|---|---|
| Unités de test | Cas de test | RF 7.5 |
