...
| Name | Description |
| --- | --- |
| [Documentation] | Used for specifying a [test case documentation](../syntax/tests.md#test-case-name-and-documentation). |
| [Metadata] | Used for setting [free test metadata](../syntax/tests.md#free-test-metadata). |
| [Tags] | Used for [tagging test cases](../syntax/tests.md#tagging-test-cases). |
| [Setup] | Used for specifying a [test setup](../syntax/tests.md#test-setup-and-teardown). |
| [Teardown] | Used for specifying a [test teardown](../syntax/tests.md#test-setup-and-teardown). |
| [Template] | Used for specifying a [template keyword](../syntax/tests.md#test-templates). |
